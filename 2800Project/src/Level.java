...
public class Level {
    ...
    public Level(String name, Level left, Level right, ArrayList<Rectangle> colArr, BufferedImage title,
       ...
       // this.name = name;
        ...
        brick = loadImage("./src/lib/brick3.png");
    }
    ...
    public static Level level1(GameManager gm) {
        ...
        Level roomOne = new Level("Room1", null, null, colArr, loadImage("./src/lib/Room1.png"), enemyArr);
        ...
        Level roomTwo = new Level("Room2", roomOne, null, colArr2, loadImage("./src/lib/Room2.png"), enemyArr2);
        ...
        Level roomThree = new Level("Room3", roomTwo, null, colArr3, loadImage("./src/lib/Room3.png"), enemyArr3);
        ...
        Level roomFour = new Level("Room4", roomThree, null, colArr4, loadImage("./src/lib/Room4.png"),
                enemyArr4); 
        roomThree.rightLevel = roomFour;

        ArrayList<Enemy> enemyArr5 = new ArrayList<Enemy>();
        ArrayList<Rectangle> colArr5 = new ArrayList<Rectangle>();
        ...
        Level roomSix = new Level("Room Six",roomFive, null, colArr6, loadImage("./src/lib/Room6.png"), enemyArr6);
        ...
        Level roomSeven = new Level("Room Seven",roomSix, null, colArr7,loadImage("./src/lib/Room7.png"), enemyArr7);
        ...
        Level roomEight = new Level("Room Eight",roomSeven, null, colArr8, loadImage("./src/lib/Room8.png"), enemyArr8);
        ...
        Level roomNine = new Level("Room Nine",roomEight, null, colArr9, loadImage("./src/lib/Room9.png"), enemyArr9);
        ...
        Level roomEleven = new Level("LeftRoomOne",null, roomOne, colArr11, loadImage("./src/lib/LeftRoomOne.png"), enemyArr11);
        ...
        Level roomTwelve = new Level("LeftRoomTwo",null, roomEleven, colArr12, loadImage("./src/lib/LeftTwo.png"), enemyArr12);
        ...
        Level roomThirteen = new Level("LeftRoomThree",null, roomTwelve, colArr13, loadImage("./src/lib/LeftThree.png"), enemyArr13);
        ...
        Level roomFourteen = new Level("LeftRoomFour",null, roomThirteen, colArr14, loadImage("./src/lib/LeftRoomFour.png"), enemyArr14);
        ...
        Level roomFifteen = new Level("LeftMiniBossRoom",null,roomFourteen,colArr15,loadImage("./src/lib/LeftMiniBossRoom.png"), enemyArr15);
        ...
        Level roomSixteen = new Level("LeftRoom6",null,roomFifteen,colArr16,loadImage("./src/lib/LeftRoomSix.png"), enemyArr16);
        ...
        Level roomSeventeen = new Level("LeftRoom7",null,roomSixteen,colArr17,loadImage("./src/lib/LeftRoomSeven.png"), enemyArr17);
        ...
        Level roomEighteen = new Level("LeftRoom8",null, roomSeventeen, colArr18, loadImage("./src/lib/LeftRoomEight.png"), enemyArr18);
        ...
        Level roomNinteen = new Level("LeftRoom9",null, roomEighteen, colArr19, loadImage("./src/lib/LeftRoomNine.png"), enemyArr19);
        ...
        Level levelBossMain = new Level("BossMain",null, null, colArrBossMain, loadImage("./src/lib/BossMain.png"), enemyArrBossMain);
        ...
        enemyArrBossRight1.add(new BossBeamAttack(true,0));
         ...
         Level levelBossRight2 = new Level("right2",null, null, colArrBossRight2, loadImage("./src/lib/BossRoom.png"), enemyArrBossRight2);
        ...
        Level levelBossLeft1 = new Level("LEFT",null, levelBossMain, colArrBossLeft1, loadImage("./src/lib/BossRoom.png"), enemyArrBossLeft1);
        Level levelBossRight1 = new Level("RIGHT",levelBossMain, levelBossRight2, colArrBossRight1, loadImage("./src/lib/BossRoom.png"), enemyArrBossRight1);
        ...
        Level levelBossLeft2 = new Level("Left2",null, levelBossLeft1, colArrBossLeft2, loadImage("./src/lib/BossRoom.png"), enemyArrBossLeft2);
        ...
        Level levelBossLeft3 = new Level("Left3",null, levelBossLeft2, colArrBossLeft3,loadImage("./src/lib/BossRoom.png"), enemyArrBossLeft3);
